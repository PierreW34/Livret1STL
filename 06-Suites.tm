...
<\body>
  ...
  utilisant la calculatrice (2 méthodes).>>>>>
  ...
  suivant, on dit que la suite est géométrique. Ce nombre constant est la
  raison de la suite, on le note <math|q> \ \ <\footnote>
    ...
    d'où la lettre utilisée.
  </footnote>.\ 

  \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ <block|<tformat|<table|<row|<cell|Formules>|<cell|<tabular*|<tformat|<table|<row|<cell|Par
  récurrence>|<cell|<math|u<rsub|n+1>=q\<cdot\>u<rsub|n>>>>|<row|<cell|>|<cell|>>|<row|<cell|Explicite>|<cell|<math|u<rsub|n>=u<rsub|0>\<cdot\>q<rsup|n>>>>>>>>>>>>
  ...
  <\example>
    ...
    En déduire <math|u<rsub|20>>.>|<cell|>>|<row|<cell|>|<cell|>|<cell|<math|u<rsub|20>=>>>>>>
  </example>

  <new-page*> \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ <block*|<tformat|<cwith|1|-1|1|1|cell-background|pastel
  cyan>|<table|<row|<cell|Augmenter de <math|t>% revient à multiplier par
  <math|1+<dfrac|t|100>>>>|<row|<cell|Diminuer de <math|t>% revient à
  ...
  <\example>
    Le service commercial d'un journal a constaté que chaque année il
    enregistre une baisse du nombre d'abonnés de 2%. En 2015, le journal
    comptait 4000 abonnés.

    On note <math|u<rsub|n>> le nombre d'abonnés en <math|2015+n>.

    <\enumerate-alpha>
      <item>Calculer le nombre d'abonnés en 2016.

      <item>Démontrer que <math|<around*|(|u<rsub|n>|)>> est une suite
      géométrique de raison <math|q=0,98> et <math|u<rsub|0>=4000>

      <item>Déterminer \ <math|u<rsub|n>> en fonction de <math|n>. En déduire
      le nombre d'abonnés en 2025.
    </enumerate-alpha>
  </example>
  ...
  <math|u<rsub|0>=4000> ; <math|u<rsub|n+1>=0,98u<rsub|n>>>|<\cell>
    ...
    Même suite ; on cherche la première valeur de <math|n> pour laquelle
    <math|u<rsub|n>\<less\>3000>

    \;
  </cell>>|<row|<cell|<tabular|<tformat|<table|<row|<cell|>|<cell|U
  <math|\<longleftarrow\>> 4000>>|<row|<cell|>|<cell|Pour I allant de 1 à
  ...
  est une suite> géométrique de raison <math|q> positive.>>>>>
  ...
  <subsection|Sommes de termes consécutifs d'une suite géométrique>
...
<\auxiliary>
  <\collection>
    <\associate|toc>
      ...
      réelles> <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
      ...
      <with|par-left|<quote|1tab>|1.1<space|2spc>Par récurrence
      <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
      ...
      <with|par-left|<quote|1tab>|4.2<space|2spc>Sommes de termes consécutifs
      d'une suite géométrique <datoms|<macro|x|<repeat|<arg|x>|<with|font-series|medium|<with|font-size|1|<space|0.2fn>.<space|0.2fn>>>>>|<htab|5mm>>
